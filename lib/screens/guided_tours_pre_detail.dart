...
class GuidedToursPreDetail extends StatelessWidget {
  const GuidedToursPreDetail({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    final toursModel = context.watch<GuidedToursModel>();

    final appBarTitle =
        (english) ? AppConstants.toursLabelEn : AppConstants.toursLabel;

    final description = (english)
        ? AppConstants.guidedToursDescriptionEn
        : AppConstants.guidedToursDescription;
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Builder(
                builder: (context) {
                  if (toursModel.tours.isNotEmpty) {
                    return Column(
                      children: (accessible)
  ...
  void _showDetail(BuildContext context, Place tour) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => GuidedToursDetail(
          tour: tour,
          tourEn: tour,
